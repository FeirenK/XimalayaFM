...
def kafka_hdfs(opticons=None,hdfshost='',broker='',group='',topics=''):
    ...
    def print_assignment(consumer, s):
        ...
        while True:
            ...
            if msg is not None:
                ...
                if msg.error():
                    ...
                    localfile = '%s.%s.%s' % (database,table,type)
                    ...
                    if type == 'insert':
                        ...
                        try:
                            ...
                            # hivesql = 'load data inpath "{hivefile}" into table {database}.{table}'.format(hivefile=hivefile,database=database,table=table)
